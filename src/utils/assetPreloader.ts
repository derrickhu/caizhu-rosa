...
export const IMAGE_ASSETS: readonly string[] = [
  ...
  'subpkg_assets/images/rank_top_podium_sheet.png',
  ...
  'subpkg_assets/images/prop_panel_color_blast.png',
  'subpkg_assets/images/prop_panel_cross_clear.png',
  'subpkg_assets/images/prop_panel_wild_next.png',
